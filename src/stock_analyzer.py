...
提供纯技术指标计算和状态判断，供 Scanner 和 Agent 工具链使用。
主要功能：
1. 均线系统 - MA5/MA10/MA20/MA60 计算与趋势判断
2. MACD 指标 - DIF/DEA/柱状图 与金叉死叉信号
3. RSI 指标 - 超买超卖判断
4. 量能分析 - 量比与量价关系
5. 支撑压力 - 均线支撑与前高阻力

注意：技术指标的买卖决策权在 Scanner（量化选股）侧，
LLM Agent 侧仅使用这些数据进行风险评估和报告填充。
"""
...
class StockTrendAnalyzer:
    ...
    计算并输出技术指标状态，供 Scanner 和 Agent 使用：
    1. 趋势判断 - MA 排列与趋势强度
    2. 乖离率计算 - 价格与均线偏离度
    3. 量能分析 - 量比与量价关系
    4. 支撑压力 - 均线支撑与前高阻力
